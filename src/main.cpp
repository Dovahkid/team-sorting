...
int main() {
	...
	int* selection {fillArrayWithSet()};
	int* bubble {fillArrayWithSet()};
	int* insertion {fillArrayWithSet()};
	int* merge {fillArrayWithSet()};
	int* quick {fillArrayWithSet()};
	int* heap {fillArrayWithSet()};
	int* exchange {fillArrayWithSet()};

	cout << "\n\n<------= Exchange Sort =------>" << endl;
    timer([exchange]()->void{
        exchangeSort(exchange, 1000);
        });
    cout << "Compares: " << exchangeSortCompares << endl;
    exchangeSortCompares = 0;

	cout << "\n\n<------= Selection Sort =------>" << endl;
    timer([selection]()->void{
        selectionSort(selection, 1000);
        });
	...
	cout << "\n\n<------= Bubble Sort =------>" << endl;
    timer([bubble]()->void{
        bubbleSort(bubble, 1000);
        });
    cout << "Compares: " << bubbleSortCompares << endl;
    bubbleSortCompares = 0;
	
	cout << "\n\n<------= Insertion Sort =------>" << endl;
    timer([insertion]()->void{
        insertionSort(insertion, 1000);
        });
